...
export function WorkTogether() {
  ...
  return (
    <section id="work-together" className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-indigo-700 dark:from-blue-800 dark:to-indigo-900 text-white py-20 md:py-24">
      {/* Effet de fond animé */}
