...
export function SampanaMena90TaonaPage() {
  ...
  const structuredData = {
    ...
    about: {
      ...
      foundingDate: "1936",
      description:
        "Branche Routiers de Tily eto Madagasikara pour les jeunes de 17-19 ans"
    }
  };
