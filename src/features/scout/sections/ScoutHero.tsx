        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div className="text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed space-y-4">
                <p>{t('scout.hero.subtitle')}</p>
                <p>{t('scout.hero.mission')}</p>
                <p>{t('scout.hero.description')}</p>
              </div>
            </motion.div>
                      ...
                      onError={(e) => {
                        ...
                        if (parent && !parent.querySelector('.placeholder-logo')) {
                          ...
                          placeholder.className =
                            'placeholder-logo absolute inset-0 flex items-center justify-center bg-gradient-to-br from-blue-500 to-blue-700 text-white font-bold text-sm';
